...
/* Allocate physical memory using alloc_page(), 
   call load_file() to load file to memory from disk. */
/* After load, mapping kpage and upage using install_page(). */
bool
